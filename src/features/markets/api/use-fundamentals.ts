...
/** A ratio renders plain; a rate renders as a percent. Mixing them silently is how 0.276 becomes "0.3%". */
...
export function useFundamentals(symbol: string | undefined) {
  ...
  const metrics: Metric[] = !r
    ...
    : ([
        ...
        ['Return on equity', pct(r.return_on_equity)],
        ['Revenue growth', pct(r.revenue_growth)],
        ['Dividend yield', pct(r.dividend_yield)],
